...
(2) The elite pool strategy provides agents with diverse search directions by leveraging stored historical optimal solutions, thereby thoroughly exploring unknown domains. 
(3) A dynamic vertical crossover strategy with a counter is proposed to trigger dimension updates when the search stagnates, which helps the algorithm evade local optima. 
